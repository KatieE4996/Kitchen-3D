...
Purpose:	Provide a Black/white floor, 3 walls, and a ceiling
...
Kitchen::Kitchen() { width = 8, depth = 8; displayListId = 0; }
Kitchen::Kitchen(GLint w, GLint d) { width = w;	depth = d; displayListId = 0; }

//get the center of the board for the camera
double Kitchen::centerx() { return width / 2; }
double Kitchen::centerz() { return depth / 2; }
